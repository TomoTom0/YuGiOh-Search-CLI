...
[ygo-search](../README.md) / listTables

# Function: listTables()

> **listTables**(): `Promise`\<`string`[]\>

Defined in: [lib/vector/searcher.ts:185](https://github.com/TomoTom0/YuGiOh-Search-CLI/blob/main/src/lib/vector/searcher.ts#L185)
