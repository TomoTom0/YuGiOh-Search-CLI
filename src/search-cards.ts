...
// ParsedOptions interface for parseArgs return type
...
function initializeOptions(): ParsedOptions {
  return {
    filterRaw: {},
    cols: null,
    mode: 'exact',
...
// Parse JSON format
function parseJsonFormat(arg: string, filterRaw: Record<string, any>): void {
  try {
