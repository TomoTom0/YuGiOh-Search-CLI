use super::db;
use super::types::*;
use crate::normalize::{normalize_for_search, MockCard, PatternExtractor, PatternReplacer, PatternType, ReplacementStatus};
use worker::*;

/// テキストを正規化する
pub async fn normalize_text(mut req: Request, _env: Env, _ctx: Context) -> Result<Response> {
...
/// パターンを抽出する
pub async fn extract_patterns(mut req: Request, _env: Env, _ctx: Context) -> Result<Response> {
...
/// パターンを置換する
pub async fn replace_patterns(mut req: Request, env: Env, _ctx: Context) -> Result<Response> {
...
/// カードを検索する
pub async fn search_cards(mut req: Request, env: Env, _ctx: Context) -> Result<Response> {
...
/// FAQを検索する
pub async fn search_faqs(mut req: Request, env: Env, _ctx: Context) -> Result<Response> {
